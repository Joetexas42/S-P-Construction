          ...
          <div className="flex h-20 items-center justify-between">
            <Link href="/" className="flex items-center gap-2 z-50">
              ...
              <div className="flex flex-col">
                <span className={`font-heading font-bold text-xl leading-none uppercase tracking-tight transition-colors duration-300 ${isTransparent ? "text-white" : "text-foreground"}`}>Scott Commercial</span>
                <span className={`text-xs uppercase font-semibold tracking-wider transition-colors duration-300 ${isTransparent ? "text-white/70" : "text-muted-foreground"}`}>Roofing</span>
              </div>
            </Link>
