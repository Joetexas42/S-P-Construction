...
export const services: ServiceDetail[] = [
  {
    ...
    icon: Search,
    category: "Core",
    seoTitle: "Free Commercial Roof Inspection in DFW | Drone & Thermal | Scott Commercial Roofing",
    seoDescription:
  ...
  },
  {
    ...
    icon: Wrench,
    category: "Core",
    seoTitle: "Commercial Roof Repair & 24/7 Leak Response | DFW | Scott Commercial Roofing",
    seoDescription:
  ...
  },
  {
    ...
    icon: LayoutGrid,
    category: "Core",
    seoTitle: "Commercial Roof Installation & Replacement | DFW | Scott Commercial Roofing",
    seoDescription:
  ...
  },
  {
    ...
    icon: LayoutGrid,
    category: "System",
    seoTitle: "Commercial Full Roof Replacement | DFW Tear-Off | Scott Commercial Roofing",
    seoDescription:
  ...
  },
  {
    ...
    icon: Zap,
    category: "System",
    seoTitle: "Commercial Hail & Storm Damage Repair | DFW Insurance Claims | Scott Commercial Roofing",
    seoDescription:
  ...
  },
  {
    ...
    icon: Droplets,
    category: "System",
    seoTitle: "24/7 Emergency Commercial Roof Leak Repair | DFW | Scott Commercial Roofing",
    seoDescription:
    ...
    heroImage: {
      ...
      alt: "S&P Construction crew in high-visibility gear working by headlamp on a wet commercial rooftop during a night emergency response",
    },
    supportingImages: [
      {
  ...
  },
  {
    ...
    icon: ArrowUpToLine,
    category: "System",
    seoTitle: "Commercial Roof Coatings & Restoration | DFW Silicone & Acrylic | Scott Commercial Roofing",
    seoDescription:
  ...
  },
  {
    ...
    category: "System",
    seoTitle: "Commercial Flat & Low-Slope Roofing | DFW | TPO, PVC, BUR | Scott Commercial Roofing",
    seoDescription:
  ...
  },
  {
    ...
    icon: Layers,
    category: "System",
    seoTitle: "Commercial Metal Roofing | DFW Standing Seam & R-Panel | Scott Commercial Roofing",
    seoDescription:
  ...
  },
  {
    ...
    icon: Box,
    category: "System",
    seoTitle: "Commercial TPO, EPDM & PVC Membrane Roofing | DFW | Scott Commercial Roofing",
    seoDescription:
