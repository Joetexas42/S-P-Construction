...
export const cities: CityData[] = [
  {
    ...
    testimonials: [
      ...
      {
        quote:
          "We run a refrigerated food distribution floor that can't be open to outside air for more than 90 minutes at a stretch. Lone Star re-engineered our drainage, eliminated 17 ponding spots, and installed 120,000 sq ft of Sika PVC in dry-in stages without ever breaking our cold chain.",
        name: "Antonio Reyes",
        businessType: "Cold Storage Facilities Director",
      },
      {
        quote:
          "Our Design District warehouse had three roofers tell us we needed a full tear-off. Lone Star's infrared survey proved otherwise, recovered the dry sections, and saved us almost $200k. Two summers in, not a single leak callback.",
        name: "Priya Nair",
    ...
    recentProjects: [
      {
        ...
        image: "/images/projects/dallas-pvc-warehouse.png",
        completed: "July 2025",
      },
      {
        ...
        image: "/images/projects/dallas-metal-medical.png",
  ...
  },
  {
    ...
    testimonials: [
      ...
      {
        quote:
          "Our Stockyards-area restaurant has a 90-year-old parapet wall that every contractor was afraid to touch. Lone Star detailed the flashings, tied in a new TPO field, and made it watertight without changing the historic look. Outstanding craftsmanship.",
    ...
    recentProjects: [
      {
        ...
        sqFt: 85000,
        system: "24-Gauge Standing Seam Metal",
        image: "/images/projects/fortworth-metal-alliance.png",
      ...
      },
      {
        ...
        image: "/images/projects/fortworth-tpo-stockyards.png",
  ...
  },
  {
    ...
    testimonials: [
      ...
      {
        quote:
          "We brought Lone Star in for a second opinion on a leaking new-construction roof at one of our Fields-area pad sites. They isolated the issue to an improperly detailed scupper in under 30 minutes and had it permanently sealed the same week.",
        name: "Anika Patel",
    ...
    recentProjects: [
      {
        ...
        image: "/images/projects/frisco-tpo-retail.png",
      ...
      },
      {
        ...
        sqFt: 60000,
        system: "60-mil GAF EverGuard TPO",
        image: "/images/projects/frisco-tpo-office.png",
  ...
  },
  {
    ...
    testimonials: [
      {
        quote:
          "Golf-ball hail in April put 400+ punctures through our built-up roof across three office buildings. Lone Star tarped within four hours, documented the entire scope for our carrier, and got us a 100% replacement-cost approval. We're back to watertight with a 15-year GAF warranty.",
        name: "Rachel Okafor",
        businessType: "Class-A Office Property Manager",
      },
      {
        quote:
          "Our Legacy West tenants include three of the most demanding F500 names in the metroplex. Lone Star phased a 90,000 sq ft TPO reroof over six weekends, low-odor adhesives only, and we never got a single elevated indoor air-quality complaint.",
        name: "Christopher Dalton",
        businessType: "Corporate Campus Asset Manager",
      },
      {
        quote:
          "I've used four roofers across our medical portfolio. Lone Star is the only one that consistently shows up on time, sends written daily updates, and bills exactly what they quoted. They handle our Plano and Frisco medical buildings now.",
        name: "Yolanda Briggs",
    ...
    recentProjects: [
      {
        ...
        image: "/images/projects/plano-storm-office.png",
      ...
      },
      {
        ...
        sqFt: 90000,
        system: "60-mil Carlisle TPO",
        image: "/images/projects/plano-tpo-legacy.png",
  ...
  },
  {
    ...
    testimonials: [
      ...
      {
        quote:
          "Our 1920s downtown building had been patched a dozen times. Lone Star pulled it back to deck, rebuilt the parapets properly, and detailed every penetration. Two storms later it's still bone dry — first time in fifteen years.",
        name: "Walter Kemp",
    ...
    recentProjects: [
      {
        ...
        sqFt: 28000,
        system: "60-mil GAF EverGuard TPO",
        image: "/images/projects/mckinney-tpo-medical.png",
        completed: "May 2025",
      },
      {
        ...
        image: "/images/projects/mckinney-historic-parapet.png",
  ...
  },
  {
    ...
    testimonials: [
      ...
      {
        quote:
          "We manage hospitality near the Entertainment District — game days mean we can't have crews on the roof. Lone Star built a phased schedule around the home calendar and finished a 55,000 sq ft PVC install without a single conflict.",
        name: "Tatiana Brooks",
    ...
    recentProjects: [
      {
        ...
        image: "/images/projects/arlington-pvc-school.png",
      ...
      },
      {
        ...
        image: "/images/projects/arlington-storm-warehouse.png",
        completed: "June 2025",
      },
    ],
  },
