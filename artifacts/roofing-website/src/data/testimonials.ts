...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    quote:
      "Golf-ball hail in April put 400+ punctures through our built-up roof across three office buildings. S&P Construction tarped within four hours, documented the entire scope for our carrier, and got us a 100% replacement-cost approval. We are back to watertight with a 15-year GAF warranty.",
    name: "Rachel Okafor",
  ...
  },
  {
    ...
    quote:
      "We run a refrigerated food distribution floor that cannot be open to outside air for more than 90 minutes at a stretch. S&P Construction re-engineered our drainage, eliminated 17 ponding spots, and installed 120,000 sq ft of Sika PVC in dry-in stages without ever breaking our cold chain.",
    name: "Antonio Reyes",
    role: "Director of Facilities",
    company: "S&P Construction Cold Logistics",
    city: "Dallas, TX",
  ...
  },
  {
    ...
    quote:
      "Our Las Colinas hotel had a chronic leak above two guest floors that two other contractors couldn't isolate. S&P Construction's infrared survey found the source in under an hour and sealed it permanently the same week. They are now on our preferred vendor list for the entire portfolio.",
...
const BUSINESS_NAME = "S&P Construction";
