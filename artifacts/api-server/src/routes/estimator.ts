...
router.post("/estimator", async (req, res) => {
  ...
  const html = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 640px; margin: 0 auto; color: #0f172a;">
      ...
      <p style="margin-top: 24px; font-size: 12px; color: #64748b;">This is an automated lead notification from the S&P Construction instant estimator. The dollar figure shown is a ballpark generated from per-sqft pricing — not a binding quote.</p>
    </div>
  `;
